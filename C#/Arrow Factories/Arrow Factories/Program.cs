...
Arrow GetArrow()
{
    Console.WriteLine("Would you like a custom arrow, or would you like to chose from our standards? (Elite, Beginner, Marksman?");
...
internal class Arrow
{
    ...
    {
        return new Arrow(ArrowHead.Steel, Fletch.Plastic, 95);
    }

    public static Arrow CreateBeginnerArrow()
    {
        return new Arrow(ArrowHead.Wood, Fletch.GooseFeathers, 75);
    }

    public static Arrow CreateMarksmanArrow()
    {
        return new Arrow(ArrowHead.Steel, Fletch.GooseFeathers, 65);
    }
}

enum ArrowHead { Steel, Wood, Obisidan }
enum Fletch { Plastic, TurkeyFeathers, GooseFeathers }
enum CommonArrows { Elite, Beginner, Marksman }